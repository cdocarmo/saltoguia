...
$(document).ready(function(){
    ...
    $('#btn-actualizar').on('click', function(){
        $('#actualizar-id').val($(fila_seleccionada).find('.paciente-id').html());  //oculto, TODO: revisar seguridad de esto
        $('#actualizar-nombres').val($(fila_seleccionada).find('.paciente-nombres').html());
        $('#actualizar-apellidos').val($(fila_seleccionada).find('.paciente-apellidos').html());
        $('#actualizar-domicilio').val($(fila_seleccionada).find('.paciente-domicilio').html());
        $('#actualizar-ci').val($(fila_seleccionada).find('.paciente-ci').html());
        $('#actualizar-email').val($(fila_seleccionada).find('.paciente-email').html());
        $('#actualizar-comentarios').val($(fila_seleccionada).find('.paciente-comentarios').html());
        return true;
    });
    ...
    $('#actualizar').on('click', function(){
        ...
        data['datatype'] = 'json';
        data['success'] = function(response) {
            $(fila_seleccionada).find('.paciente-nombres').html(postdata['nombres']);
            $(fila_seleccionada).find('.paciente-apellidos').html(postdata['apellidos']);
            $(fila_seleccionada).find('.paciente-domicilio').html(postdata['domicilio']);
            $(fila_seleccionada).find('.paciente-ci').html(postdata['ci']);
            $(fila_seleccionada).find('.paciente-email').html(postdata['email']);
            $(fila_seleccionada).find('.paciente-email').html(postdata['comentarios']);
