...
DATABASES = {
    'default': {
        ...
        'NAME': 'saltoguia',                      # Or path to database file if using sqlite3.
        'USER': 'saltoguia',                      # Not used with sqlite3.
...
MEDIA_ROOT = '%s/media/' % PROJECT_ABSOLUTE_DIR
...
SECRET_KEY = 'ep++7e%#n=rf_2ax)ne1-8%5rf3-n4*qr6erj6zthpb9r1w9!8'
